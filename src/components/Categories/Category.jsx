						...
						<button
							onClick={() => {
								if (window.innerWidth <= 576) {
									// Якщо ширина екрану менше або дорівнює 768 пікселям, то завантажуємо лише одну карточку
									setParams({ ...params, limit: 1, offset: params.offset + params.limit });
								} else {
									// В іншому випадку завантажуємо задану кількість карточок (params.limit)
									setParams({ ...params, offset: params.offset + params.limit });
								}
							}}
						>
